...
public class CompletableFutureMain {
    ...
    private static void test8() throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            completableFutures[i] = CompletableFuture.supplyAsync(new Supplier<Integer>() {
                @Override
                public Integer get() {
                    return 1;
                }
        ...
        Integer u = CompletableFuture.allOf(completableFutures).thenApply(new Function<Void, Integer>() {
            @Override
            public Integer apply(Void result) {
                return 1;
            }
        }).get();
